...
import { sendChessMove } from "../../../services/GameService";
...
const PawnPromotionModalWindow: FC<Props> = ({playerColor, pieceCoords, setChessCoordsToChangeVisibility}) => {
  ...
  function makeChessMove(e: React.MouseEvent<any>, pawnPromotionPieceCoords: IChessCoords): void {
    ...
    try {
      if (gameData.game && !gameData.sendingChessMove) {

        const endPiece: IBoardCellEntity = gameData.game.boardState[pieceCoords.numberCoord][pieceCoords.letterCoord] as IBoardCellEntity
